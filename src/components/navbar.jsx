...
const Navbar = () => {
  ...
  localStorage.setItem('sidebar-status', sideBar);
        ...
        <div className='navbar-main-1'>
          ...
          <div className='account-div'>
            <div className='account-sub-div'>
              ...
              <div
                className={
                  account ? 'create-acc-div-1' : 'create-acc-div-hidden'
                }
              >
          ...
          <div className='cart-div'>
            ...
            <div
              className={
                cart ? 'cart-product-div-1' : 'cart-product-div-hidden'
              }
            >
        ...
        <div className='navbar-main-2'>
          <div className='account-div'>
            <div className='account-sub-div'>
              ...
              <div
                className={
                  account ? 'create-acc-div-2' : 'create-acc-div-hidden'
                }
              >
                <h4 id='login-div'>Login to your account</h4>
                <form className='account-form' action=''>
          ...
          <div
            className={cart ? 'cart-product-div-2' : 'cart-product-div-hidden'}
          >
            <ul className='product-ul'>
              <li className='product-li'>
                <a href='#'>Product</a>
